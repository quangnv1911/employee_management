...
********************************************************************************/
IF EXISTS (SELECT name FROM master.dbo.sysdatabases WHERE name = N'EmployeeManagement')
BEGIN
	ALTER DATABASE [EmployeeManagement] SET OFFLINE WITH ROLLBACK IMMEDIATE;
	ALTER DATABASE [EmployeeManagement] SET ONLINE;
